...
| 項目 | 配列[いずれか：link:#cluster_1_5_get_response_body["cluster_1.5_get_response_body"]、配列[]] | True  a| 
...
| connectorCapabilities | array[string] | False  a| 
