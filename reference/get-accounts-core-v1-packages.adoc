...
* 例：id、packageName、packageVersion、softwareType
...
| 項目 | 配列[いずれか：link:#package_1_0_get_response_body["package_1.0_get_response_body"]、配列[]] | True  a| 
