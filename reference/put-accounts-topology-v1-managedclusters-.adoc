...
* defaultStorageClassが変更されると、Kubernetesのデフォルトのストレージクラスが更新されます。
...
| protectionStateDetails | 配列[link:#type_astra_stateDetail["type_astra_stateDetail"]] | False  a| 
